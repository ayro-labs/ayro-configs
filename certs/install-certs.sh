...
sudo certbot certonly -d ayro.io --standalone \
  --cert-path $AYRO_HOME/ayro-configs/certs/ayro.io/cert.pem \
  --key-path $AYRO_HOME/ayro-configs/certs/ayro.io/privkey.pem \
  --chain-path $AYRO_HOME/ayro-configs/certs/ayro.io/chain.pem \
  --fullchain-path $AYRO_HOME/ayro-configs/certs/ayro.io/fullchain.pem

echo "Installing api.ayro.io certificate..."
sudo certbot certonly -d api.ayro.io --standalone \
  --cert-path $AYRO_HOME/ayro-configs/certs/api.ayro.io/cert.pem \
  --key-path $AYRO_HOME/ayro-configs/certs/api.ayro.io/privkey.pem \
  --chain-path $AYRO_HOME/ayro-configs/certs/api.ayro.io/chain.pem \
  --fullchain-path $AYRO_HOME/ayro-configs/certs/api.ayro.io/fullchain.pem

echo "Installing www.ayro.io certificate..."
sudo certbot certonly -d www.ayro.io --standalone \
  --cert-path $AYRO_HOME/ayro-configs/certs/www.ayro.io/cert.pem \
  --key-path $AYRO_HOME/ayro-configs/certs/www.ayro.io/privkey.pem \
  --chain-path $AYRO_HOME/ayro-configs/certs/www.ayro.io/chain.pem \
  --fullchain-path $AYRO_HOME/ayro-configs/certs/www.ayro.io/fullchain.pem

echo "Installing webcm.ayro.io certificate..."
sudo certbot certonly -d webcm.ayro.io --standalone \
  --cert-path $AYRO_HOME/ayro-configs/certs/webcm.ayro.io/cert.pem \
  --key-path $AYRO_HOME/ayro-configs/certs/webcm.ayro.io/privkey.pem \
